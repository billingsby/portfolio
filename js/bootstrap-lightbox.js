...
(function() {
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.enable = function() {
      var _this = this;
      return $("body").on("click", ".thumbnails[data-toggle^=lightbox] .insta-trigger", function(e) {
    ...
    Lightbox.prototype.start = function($link) {
      ...
      imageNumber = 0;
      current = 0;
      if ($link.parents(".thumbnails").attr("data-toggle") === "lightbox" && $link.parents(".thumbnails").find(".insta-trigger").length) {
        _ref = $link.parents(".thumbnails").find(".insta-trigger");
